    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Food Management Console',style: TextStyle(color: Colors.black),),
         bottom: TabBar(
          tabs: [
            Tab(child: Text("Store",style: Styles.captionTextStyle,),icon: Icon(Icons.store,color: Styles.themePrimary,)),
            Tab(child: Text("Item",style: Styles.captionTextStyle),icon: Icon(Icons.fastfood,color: Styles.themePrimary)),
            Tab(child: Text("Extras",style: Styles.captionTextStyle),icon: Icon(Icons.add_shopping_cart,color: Styles.themePrimary)),
            Tab(child: Text("Drinks",style: Styles.captionTextStyle),icon: Icon(Icons.local_drink,color: Styles.themePrimary)),
            Tab(child:Text("Menu",style: Styles.captionTextStyle),icon: Icon(Icons.restaurant_menu,color: Styles.themePrimary))
          ],
        ),),
        body: TabBarView(
         children: [
